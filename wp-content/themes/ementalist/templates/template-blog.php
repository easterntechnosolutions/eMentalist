...
//     'taxonomy' => 'category',
//     'hide_empty' => false,
//     'exclude' => get_term_by('slug', 'efin-servies', 'category')->term_id,
// ));
...
<!-- Home 11 - Section 2 -->
<section class="box-section box-our-services-11">
    <div class="container">
        <div class="row mt-5">
            <?php
            // Get all categories
            ...
            if (!empty($categories) && !is_wp_error($categories)) {
                foreach ($categories as $category) {
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card-service-6" data-aos="fade-up" data-aos-duration="0">
                            <div class="card-image">
                                <!-- You can add a category-specific icon here if needed -->
                            </div>
                            <div class="card-info">
                                <h3 class="heading-ag-xl dark-950"><?php echo esc_html($category->name); ?></h3>
                                <p class="paragraph-rubik-r dark-950-70"><?php echo esc_html($category->description); ?></p>
                                <a href="<?php echo esc_url(get_category_link($category->term_id)); ?>" class="readmore sub-heading-ag-md">Read More
                                    <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12.7291 10.1533C12.3596 9.69869 12.1635 8.73092 12.0604 7.86866C11.9256 6.75741 11.9573 5.66659 12.1934 4.66189C12.3705 3.90862 12.6605 3.08807 13.1242 2.71125M13.1242 2.71125C12.6605 3.08807 11.7975 3.20443 11.0244 3.22332C9.99212 3.24835 8.91789 3.05622 7.85869 2.69826C7.03526 2.42032 6.12707 2.02917 5.75863 1.57579M13.1242 2.71125L1.48325 12.1711" stroke="" stroke-width="2" />
                                    </svg>
                                </a>
                            </div>
                        </div>
